...
export type LineChartDimensions = {
  /** Ref на корневой контейнер для отслеживания его ширины. */
  ...
  PAD_B: number;
  /** Внутренняя ширина области графика (`W − PAD_L − PAD_R`). */
  iw: number;
  /** Внутренняя высота области графика (`H − PAD_T − PAD_B`). */
  ih: number;
};

export function useLineChartDimensions(): LineChartDimensions {
